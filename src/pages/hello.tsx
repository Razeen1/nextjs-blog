...
function MyButton(props: {
    test: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | PromiseLikeOfReactNode | null | undefined;
}) {
    return (
        <button>
            I'm a button {props.test}
        </button>
    );
}
...
export default function hello() {
    return (
        <main className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
